...
## Sprint 12 — Segurança do Backend e Hardening
...
- [ ] **12.1.1** Implementar rate limiting no endpoint de login
...
- [ ] **12.1.2** Implementar token blacklist para logout seguro
...
- [ ] **12.1.3** Fortalecer requisitos de senha
...
- [ ] **12.1.4** Implementar account lockout após tentativas falhadas
...
- [ ] **12.1.5** Adicionar RBAC (Role-Based Access Control) básico
...
- [ ] **12.2.1** Implementar sanitização de inputs em todos os endpoints
...
- [ ] **12.2.2** Implementar audit log para ações críticas
...
- [ ] **12.2.3** Criptografar dados sensíveis em trânsito (channel_config, credentials)
...
- [ ] **12.2.4** Implementar rotação de chaves de criptografia
...
- [ ] **12.3.1** Adicionar resource limits nos containers Docker
...
- [ ] **12.3.2** Configurar Redis com autenticação
...
- [ ] **12.3.3** Implementar request payload size limits
...
- [ ] **12.3.4** Adicionar security headers via middleware
